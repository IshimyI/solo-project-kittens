  ...
  return (
    <div className="flex items-center justify-center h-screen overflow-hidden bg-gradient-to-br from-kitt-background via-kitt-foreground/40 to-kitt-background text-kitt-txt px-4">
      <form
        ...
        className="relative bg-kitt-foreground p-8 pt-16 rounded-2xl shadow-2xl border border-white/20 max-w-sm w-full"
      >
        <img
          src="/imgs/coat1.png"
          alt=""
          aria-hidden="true"
          className="absolute -top-24 left-1/2 -translate-x-1/2 w-48 drop-shadow-xl select-none pointer-events-none"
        />
